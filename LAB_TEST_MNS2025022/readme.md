...
This README was generated by inspecting the uploaded archive `dh-wasm-project.zip`.
It lists the actual files and folders found inside and contains the macOS-specific commands
you can use to build and run the project locally.
...
- React.js / Next.js (if present in the project)
- Express.js (server)
