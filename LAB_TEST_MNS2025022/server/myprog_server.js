...
function findWasmBinary() {
  return locateFile('myprog_server.wasm');
}
...
var _modexp = Module['_modexp'] = makeInvalidEarlyAccess('_modexp');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['modexp'] != 'undefined', 'missing Wasm export: modexp');
  _modexp = Module['_modexp'] = createExportWrapper('modexp', 3);
